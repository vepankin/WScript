...
OpenLogFile();
LogWrite("Start SEND Mail from UD");
CloseLogFile();
WshShell.Run(path_1cv8UD + " ENTERPRISE /S" + srvnameUD + " /N" + usernameUD + " /P" + userpassUD + " /AU- /Out" + strLogFileName + " -NoTruncate /DisableStartupMessages /C\"/EP" + CurDir + "\\ќтправитьѕисьма”ƒ.epf-ExitOnError\"",2,1);
