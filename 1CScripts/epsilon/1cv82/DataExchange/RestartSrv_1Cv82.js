...
do{
	WshShellApp.ServiceStop("1C:Enterprise 8.2 Server Agent",false);
	WScript.Sleep(2000);

}while(WshShellApp.IsServiceRunning("1C:Enterprise 8.2 Server Agent"));

// запускаем сервис, пока не запустится
do{
	WshShellApp.ServiceStart("1C:Enterprise 8.2 Server Agent",false);
	WScript.Sleep(2000);
